...
def main():
    ...
    predictor = _get_predictor(model, test_loader, output_file, config) # We can have just one predictor, because we are saving it all to one file


    # prev_iter = (None, None, None)
    prev_iter = (None, None, None, None, None, None)
    ...
    for test_loader in get_test_loaders(config):
        ...
        # predictor.predict()
        prev_iter = predictor.predict()
        # print(prev_iter)

    # predictor.predict(prev_iter, is_last=True)
